...
<div class="space-y-8">
  ...
  <!-- Max Players -->
  <div class="space-y-2">
    <label class="text-sm font-medium text-cubelit-text">Max Players</label>
    <input
      type="number"
  ...
  <!-- Ports -->
  <div class="space-y-3">
    <label class="text-sm font-medium text-cubelit-text">Ports</label>
  ...
  <!-- Database (MariaDB) -->
  <div class="space-y-3">
    <label class="text-sm font-medium text-cubelit-text">Database (MariaDB)</label>
    ...
    <div class="space-y-3">
      <div class="space-y-1.5">
        <label class="text-xs text-cubelit-muted">Root Password <span class="text-cubelit-muted/60">(leave empty for no password)</span></label>
        <input
          type="text"
      ...
      <div class="space-y-1.5">
        <label class="text-xs text-cubelit-muted">Host Port</label>
        <input
          type="number"
